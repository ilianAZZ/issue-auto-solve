  ...
  return (
    <section className="overflow-hidden rounded-xl border border-border bg-panel shadow-[0_1px_2px_rgba(16,16,24,.06),0_8px_24px_rgba(16,16,24,.06)]">
      <table className="w-full border-collapse">
        <thead>
          <tr>
            <th className="w-[130px] border-b border-border bg-panel-2 px-4 py-2.5 text-left text-[11.5px] font-semibold tracking-wide text-muted uppercase">
              State
            </th>
            <th className="w-[84px] border-b border-border bg-panel-2 px-4 py-2.5 text-left text-[11.5px] font-semibold tracking-wide text-muted uppercase">
              Issue
            </th>
            <th className="border-b border-border bg-panel-2 px-4 py-2.5 text-left text-[11.5px] font-semibold tracking-wide text-muted uppercase">
              Title
            </th>
        ...
        <tbody>
          {tasks?.map((task) => (
            ...
            >
              ...
              <td className="px-4 py-3 align-middle font-[tabular-nums] text-muted">#{task.number}</td>
